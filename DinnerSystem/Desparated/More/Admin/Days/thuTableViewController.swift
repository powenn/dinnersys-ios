...
class thuTableViewController: UITableViewController {
...
self.tableView.reloadData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "thuCell", for: indexPath)
        let menu = thuArr[indexPath.row]
