...
class tueTableViewController: UITableViewController {
...
self.tableView.reloadData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tueCell", for: indexPath)
        let menu = tueArr[indexPath.row]
